...
#[doc = "When written: when the player cancels a docking request"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"When written: when the player cancels a docking request\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"MarketID\","]
#[doc = "    \"StationName\","]
...
pub struct DockingCancelled {
    #[serde(skip_deserializing, default = "DockingCancelled::event_value")]
    pub event: String,
...
impl ::std::convert::From<&DockingCancelled> for DockingCancelled {
    fn from(value: &DockingCancelled) -> Self {
        value.clone()
    }
}

impl DockingCancelled {
    pub fn event_value() -> ::std::string::String {
        "DockingCancelled".to_string()
    }
}
