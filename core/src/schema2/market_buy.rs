...
#[doc = "When Written: when purchasing goods in the market"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"When Written: when purchasing goods in the market\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"BuyPrice\","]
#[doc = "    \"Count\","]
...
pub struct MarketBuy {
    ...
    #[serde(rename = "Count")]
    pub count: i64,
    #[serde(skip_deserializing, default = "MarketBuy::event_value")]
    pub event: String,
...
impl ::std::convert::From<&MarketBuy> for MarketBuy {
    fn from(value: &MarketBuy) -> Self {
        value.clone()
    }
}
