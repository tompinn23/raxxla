...
pub struct LeftSquadron {
    #[serde(skip_deserializing, default = "LeftSquadron::event_value")]
    pub event: String,
    #[serde(
        rename = "SquadronID",
        default,
...
impl ::std::convert::From<&LeftSquadron> for LeftSquadron {
    fn from(value: &LeftSquadron) -> Self {
        value.clone()
    }
}
