...
#[doc = "Lists the contents of the backpack, in a separate backpack.json file"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"Lists the contents of the backpack, in a separate backpack.json file\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"event\","]
#[doc = "    \"timestamp\""]
...
pub struct Backpack {
    ...
    #[serde(skip_deserializing, default = "Backpack::event_value")]
    pub event: String,
    #[serde(
        rename = "Items",
        default,
...
impl ::std::convert::From<&Backpack> for Backpack {
    fn from(value: &Backpack) -> Self {
        value.clone()
    }
}
#[doc = "`ComponentsItem`"]
