...
pub struct ClearImpound {
    #[serde(skip_deserializing, default = "ClearImpound::event_value")]
    pub event: String,
...
impl ::std::convert::From<&ClearImpound> for ClearImpound {
    fn from(value: &ClearImpound) -> Self {
        value.clone()
    }
}
