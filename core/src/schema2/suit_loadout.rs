...
#[doc = "This event is logged when starting on-foot or when disembarking"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"This event is logged when starting on-foot or when disembarking\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"LoadoutID\","]
#[doc = "    \"LoadoutName\","]
...
pub struct SuitLoadout {
    #[serde(skip_deserializing, default = "SuitLoadout::event_value")]
    pub event: String,
...
impl ::std::convert::From<&SuitLoadout> for SuitLoadout {
    fn from(value: &SuitLoadout) -> Self {
        value.clone()
    }
}
