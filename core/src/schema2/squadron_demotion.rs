...
pub struct SquadronDemotion {
    #[serde(skip_deserializing, default = "SquadronDemotion::event_value")]
    pub event: String,
...
impl ::std::convert::From<&SquadronDemotion> for SquadronDemotion {
    fn from(value: &SquadronDemotion) -> Self {
        value.clone()
    }
}

impl SquadronDemotion {
    pub fn event_value() -> ::std::string::String {
        "SquadronDemotion".to_string()
    }
}
