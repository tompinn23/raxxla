...
#[doc = "When written: when the player requests docking at a station"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"When written: when the player requests docking at a station\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"MarketID\","]
#[doc = "    \"StationName\","]
...
pub struct DockingRequested {
    #[serde(skip_deserializing, default = "DockingRequested::event_value")]
    pub event: String,
    #[serde(
        rename = "LandingPads",
        default,
...
impl ::std::convert::From<&DockingRequested> for DockingRequested {
    fn from(value: &DockingRequested) -> Self {
        value.clone()
    }
}
#[doc = "`LandingPads`"]
...
impl DockingRequested {
    pub fn event_value() -> ::std::string::String {
        "DockingRequested".to_string()
    }
}
