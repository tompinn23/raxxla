...
#[doc = "When written: when paying off bounties"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"When written: when paying off bounties\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"Amount\","]
#[doc = "    \"ShipID\","]
...
pub struct PayBounties {
    ...
    #[serde(skip_deserializing, default = "PayBounties::event_value")]
    pub event: String,
...
impl ::std::convert::From<&PayBounties> for PayBounties {
    fn from(value: &PayBounties) -> Self {
        value.clone()
    }
}
